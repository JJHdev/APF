...
/**
 * [DAO클래스] - 운영관리-경영체 데이터 업로드를 관리하는 DAO 클래스
 * 
...
public class SprtUldDAO extends BaseDAO {
    ...
    /**
     * 운영관리-경영체 데이터 업로드-경영체목록 페이징목록 조회
     */

...
public class BbsFileVO extends BaseModel implements FileVO {
	...
	public FileInfo getFileInfo() {
		return FileInfo.builder()
				...
				.fileName(getFileNm())
				.docuNo  (String.valueOf(getPstNo()))
				.docuCd  (getTaskSeCd())
				.fileSe  (getFileSeCd())
				.build();
	}
	...
	public void setFileInfo(FileInfo fileInfo) {
		...
		if (CommUtils.isNotEmpty(fileInfo.getDocuNo()))
			setPstNo     (new Long(fileInfo.getDocuNo()));
	...
	public void setDocuNo(String docuNo) {
		this.pstNo = CommUtils.getLong(docuNo, 0);
	}
	...
	@Override
	public String getDocuYn() { return null; }
	@Override

...
public class EntFileController extends BaseController {
	 ...
	 * 업체첨부파일 목록조회 JSON 반환
	 */
	@RequestMapping("/adm/file/getListEntFile.do")
	@ResponseBody
     ...
     * 업체첨부파일 조회JSON 반환
     */
    @RequestMapping("/adm/file/getEntFile.do")
    @ResponseBody
	 ...
	 * 업체첨부파일 다운로드
	 */
	@RequestMapping("/adm/file/downloadEntFile.do")
	 ...
	 * 업체첨부파일 단일파일 삭제처리
	 */
	@RequestMapping("/adm/file/deleteEntFile.do")
	@ResponseBody
     ...
     */
    @RequestMapping("/adm/file/saveEntFile.do")
    @ResponseBody
    public Map saveEntFile(@ModelAttribute EntFileVO entFileVO
        ...
        // 업체첨부파일를 저장한다.
		entFileService.saveEntFile(entFileVO, files);
		// 성공결과 반환
		return getSuccess();
    }
     ...
     * 문서/미디어 URL링크보기
     */
    @RequestMapping(value="/adm/file/linkEntFile.do")
    @ResponseBody

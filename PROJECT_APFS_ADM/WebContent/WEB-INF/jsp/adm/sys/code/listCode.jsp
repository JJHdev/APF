	...
	<div class="searchlist">
		<form id="searchForm" name="searchForm" method="post" onsubmit="return false;">
           	<div class="form-label-box">
      			<div class="box">
					<div class="area select bb-0 bl-0 br-0 pt-2 rounded-0 d-flex justify-content-between">
						<label class="txt1">사용 구분</label>
						<div id="appSrchUseYn" ></div>
					</div>
				</div>
				
				<div class="box">
					<div class="area select">
						<label class="txt1">상위코드</label>
						<div class="input-element icons-ver">
							<select name="srchType" id="srchType" title="상위코드"></select>

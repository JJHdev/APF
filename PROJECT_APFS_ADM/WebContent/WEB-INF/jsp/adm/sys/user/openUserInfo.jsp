		...
		<div class="form-label-box">
			<div class="box">
				<div class="area select">
					<label class="txt1">권한</label>
					<div class="input-element icons-ver">
						<select name="srchRoleId" id="srchRoleId" title="권한" ></select>
			...
			<div class="box">
				<div class="area select ">
					...
					<div class="input-element icons-ver">
			            <input id="srchText" name="srchText" type="text" title="검색어입력" placeholder="검색어를 입력하세요."/>
					</div>
				</div>
			</div>
		</div>

	...
	<div class="searchlist">
		<form id="searchForm" name="searchForm" method="post" onsubmit="return false;">
           	<div class="form-label-box">
				...
				<div class="box">
					<div class="area select">
						<label class="txt1">상위메뉴</label>
						<div class="input-element icons-ver">
							<select name="srchUpId" id="srchUpId" title="상위메뉴"></select>
							<i class="icon-angle-down right"></i>
						</div>
					</div>
				</div>
				<div class="box">
					<div class="area select ">
						...
						<div class="input-element icons-ver">
							<input  id="srchText" name="srchText" type="text" title="검색어입력" placeholder="메뉴ID, 메뉴명, URL등을 입력하세요." style="width:350px"/>
						</div>
					</div>
				</div>
			</div>

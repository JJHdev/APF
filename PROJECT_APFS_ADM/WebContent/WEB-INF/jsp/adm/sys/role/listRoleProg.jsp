...
<div class="content">
	<div class="row grid1">
		...
		<div class="col btnbox">
				<a href="#void" id="btnAppend" class="bs-xl btn-White mb-16px"><i class="icon-angle-left"></i><span class="hiddenATag">닫기</span></a>
				<a href="#void" id="btnRemove" class="bs-xl btn-White"><i class="icon-angle-right"></i><span class="hiddenATag">닫기</span></a>
		</div>
		<div class="col">

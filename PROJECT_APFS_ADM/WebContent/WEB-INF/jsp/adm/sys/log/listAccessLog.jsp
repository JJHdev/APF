			...
			<div class="form-label-box">
				<div class="box">
					<div class="area select">
						<label class="txt1">검색키워드</label>					
						<div class="input-element icons-ver">
				             <input  id="srchText" name="srchText" type="text" title="검색키워드" placeholder="사용자, URL, IP 입력하세요."/>
						</div>
					</div>
				</div>
				<div class="row multy-box">
					<div class="col">
						<div class="box">
							<div class="area select">
								<label class="txt1">접속기간</label>					
								<div class="input-element icons-ver">
									<input type="text" name="srchStDt" id="srchStDt" title="접속기간" class="datepicker-input fs-10px">
					...
					<div class="col">
						<div class="box">
							<div class="area select">
								<div class="input-element icons-ver">
									<input type="text" name="srchEnDt" id="srchEnDt" title="접속기간" class="datepicker-input fs-10px">
									<i class="icon-calendar right"></i>
								</div>
							</div>
						</div>

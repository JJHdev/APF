...
<!-- CENTER CONTENT START << ---------->
			<form:form commandName="modelUsr" id="selectUsrForm" name="selectUsrForm" method="post" enctype="multipart/form-data" onsubmit="return false;">
				...
				<form:hidden path="inqryTypeCd"  /><%-- 문의유형 --%>
						...
						<div class="row">
							<div class="col">
								<p class="txt2 titleTxt">
									<i class="icon-note"></i>
									[<c:out value="${modelUsr.inqryTypeNm}" />] <c:out value="${modelUsr.pstTtl}"/>
								</p>
							</div>
						</div>
					</div>
						...
						<div class="row">
							...
							<div class="col-4">
								<div class="form-area-box-input">
									<label>등록일</label>
									<div class="ele-icon-box">
									    <div class="value-box"><c:out value="${modelUsr.regDate}" /></div>
									</div>
								</div>
							</div>
							<div class="col-4">
								<div class="form-area-box-input">
									<label>상태</label>
									<div class="ele-icon-box">
									    <div class="value-box"><c:out value="${modelUsr.prcsSttsCd}" /></div>
									</div>
								</div>
							</div>
							<div class="col-12">
			...
			<!-- 사용자작성글 viewQNA -->
			<form:form commandName="modelAdm" id="selectAdmForm" name="selectAdmForm" method="post" enctype="multipart/form-data" onsubmit="return false;">
				<form:hidden path="pstNo"    /><%-- 게시물번호 --%>
				<form:hidden path="bbsSeCd"  /><%-- 게시물구분 --%>
				<form:hidden path="mode"     /><%-- 처리모드 --%>
				<form:hidden path="upPstNo"  /><%-- 상위게시판번호 --%>
				<div class="box ">
						...
						<div class="row">
							<div class="col-6">
								<div class="form-area-box-input">
									<label>작성자</label>
									<div class="ele-icon-box">
									    <div class="value-box"><c:out value="${modelAdm.rgtrNm}" /></div>
									</div>
								</div>
							</div>
							...
							<div class="col-6">
								<div class="form-area-box-input">
									<label>등록일</label>
									<div class="ele-icon-box">
									    <div class="value-box"><c:out value="${modelAdm.regDate}" /></div>
									</div>
								</div>
							</div>
							...
							<div class="col-12">
								<div class="form-area-box-input">
									...
									<div class="ele-icon-box h-auto">
										<div style="min-height:100px" class="ckEdit"> 
											<c:out value='${modelAdm.pstCn}' escapeXml="false" />
										</div>
									</div>
								</div>
							</div>

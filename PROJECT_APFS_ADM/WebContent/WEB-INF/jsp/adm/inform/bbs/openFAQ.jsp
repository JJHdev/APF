...
<div class="col right">
	<div class="row content-wrap">
		<div class="tabmenu-1">
			...
			<ul class="">
				<li>
					<a id="btnQNA"    href="javascript:void(0)" class="btn-primary w-100 my-2px"><i class="fs-18px icon-search mr-3px"></i>1:1 문의</a>
				</li>
				<li>
					<a id="btnFAQ"    href="javascript:void(0)" class="active"><i class="fs-18px icon-search mr-3px"></i>자주묻는 질문</a>
				</li>
			</ul>
		</div>
<!-- LEFT SEARCH START << ------------->

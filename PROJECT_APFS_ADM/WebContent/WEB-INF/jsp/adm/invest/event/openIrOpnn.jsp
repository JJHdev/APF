			...
			<div class="form-label-box">
				<div class="box">
					<div class="area select">
						<label class="txt1">행사명</label>					
						<div class="input-element icons-ver">
				             <input  id="srchText" name="srchText" type="text" title="행사명" placeholder="행사명을 입력하세요."/>
						</div>
					</div>
				</div>
				<div class="row multy-box">
					<div class="col">
						<div class="box">
							<div class="area select">
								<label class="txt1">행사기간</label>					
								<div class="input-element icons-ver">
									<input type="text" name="srchBgngYmd" id="srchBgngYmd" title="행사기간" class="datepicker-input fs-10px">
					...
					<div class="col">
						<div class="box">
							<div class="area select">
								<div class="input-element icons-ver">
									<input type="text" name="srchEndYmd" id="srchEndYmd" title="행사기간" class="datepicker-input fs-10px">
									<i class="icon-calendar right"></i>
								</div>
							</div>
						</div>

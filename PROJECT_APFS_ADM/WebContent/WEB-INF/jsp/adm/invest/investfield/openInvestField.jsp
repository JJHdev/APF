           	...
           	<div class="form-label-box">
				<div class="box">
					<div class="area select">
						<label class="txt1">투자분야명</label>					
						<div class="input-element icons-ver">
							<input  id="invtFldNm" name="invtFldNm" type="text" title="투자분야명" placeholder="투자분야명을 입력하세요." />
						</div>
					</div>
				</div>
				<div class="box">
					<div class="area select">
						<label class="txt1">사용시작일</label>					
						<div class="input-element icons-ver">
							<input type="text" name="srchBgngYmd" id="srchBgngYmd" title="사용시작일" class="datepicker-input" style="font-size: 11px;">
				...
				<div class="box">
					<div class="area select">
						<label class="txt1">사용여부</label>
						<div class="input-element icons-ver">
							<select name="srchUseYn" id="srchUseYn" title="사용여부" ></select>

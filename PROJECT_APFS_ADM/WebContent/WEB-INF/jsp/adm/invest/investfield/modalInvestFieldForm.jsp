<%--
*******************************************************************************
***    명칭: modalInvestFieldForm.jsp
***    설명: 운영관리-투자분야관리 등록/수정 모달팝업 화면
***
*** -----------------------------    Modified Log   ---------------------------
***    버전        수정일자        수정자        내용
*** ---------------------------------------------------------------------------
...
<form:form commandName="model" id="registForm" name="registForm" method="post" enctype="multipart/form-data" onsubmit="return false;">
	<form:hidden path="invtFldCd"	/><%-- 투자분야코드 --%>
				...
				<div class="row">
					<div class="col-12">
						<div class="form-area-box1">
							<label>투자분야명<em></em></label>
							<div class="ele-icon-box">
								<form:input path="invtFldNm" htmlEscape="false" maxLength="100"/>
							</div>											
						</div>
					</div>
					<div class="col-12">
						<div class="form-area-box1">
							<label>설명<em></em></label>
							<div class="ele-icon-box">
								<form:textarea path="invtFldCn" maxLength="1000" class="app-pre" style="min-height: 150px;"/>
							</div>
						</div>
					</div>
					<div class="col-12">
						<div class="form-area-box1">
							<label>사용기간<em></em></label>
							<div class="day">
								<div class="row">
									<div class="col">
										<div class="ele-icon-box">					
											<form:input path="useBgngYmd" placeholder="시작일을 선택하세요" class="datepicker-input"/>
									...
									<div class="col">
										<div class="ele-icon-box">					
											<form:input path="useEndYmd" placeholder="종료일을 선택하세요" class="datepicker-input"/>
											<i class="icon-calendar"></i>										
										</div>
									</div>
								</div>

			...
			<div class="form-label-box">
				<div class="box">
					<div class="area select">
						<label class="txt1">업체명</label>					
						<div class="input-element icons-ver">
				             <input  id="srchText" name="srchText" type="text" title="업체명" placeholder="업체명을 입력하세요."/>
						</div>
					</div>
				</div>
				<div class="box">
					<div class="area select">
						<label class="txt1">기업유형</label>
						<div class="input-element icons-ver">
							<select name="srchBzentySeCd" id="srchBzentySeCd" title="기업유형" ></select>
				...
				<div class="box">
					<div class="area select">
						<label class="txt1">상태</label>
						<div class="input-element icons-ver">
							<select name="srchAprvSttsCd" id="srchAprvSttsCd" title="상태" ></select>
							<i class="icon-angle-down right"></i>
						</div>
					</div>
				</div>

...
$(function() {
    ...
    P_GRID.datagrid({
        // 그리드 목록조회 URL
        url: getUrl('/adm/sys/log/getListLoginLog.do'),
        // 그리드 결과데이터 타입
        ...
        columns: [[
            ...
            {field:'userNm'       ,width:200,halign:'center',align:'center',title:'사용자명'},
            {field:'lgnDt'        ,width:350,halign:'center',align:'center',title:'로그인일시'},
            {field:'lgnYr'        ,width: 80,halign:'center',align:'center',title:'연도', hidden: true},
            {field:'lgnMm'        ,width: 65,halign:'center',align:'center',title:'월', hidden: true},
            {field:'lgnDd'        ,width: 65,halign:'center',align:'center',title:'일', hidden: true},
            {field:'lgnStusCd'    ,width:100,halign:'center',align:'center',title:'상태'},
            {field:'ipAddr'       ,width:350,halign:'center',align:'center',title:'IP주소'},
            {field:'srvrNm'       ,width:300,halign:'center',align:  'left',title:'서버명', hidden: true},
            {field:'sysNm'        ,width:200,halign:'center',align:'center',title:'시스템'}
        ]]
    });
    //========================================================//
    // 검색항목 Form Element
    ...
    function doRemove() {
        ...
        $.easyMsg.confirm(rows.length+"개의 항목을 삭제하시겠습니까?", function() {
            // AJAX로 저장처리
            $.ajaxUtil.ajaxSave(
                getUrl('/adm/sys/log/saveLoginLog.do'), 
                JSON.stringify({
                    mode: MODE.REMOVE,
                    logList: rows
                }),
    ...
    function doExcel() {
    $.formUtil.submitForm(
        getUrl('/adm/sys/log/downLoginLogExcel.do'),
        {formId : "searchForm"}
    );
    return false;
    }

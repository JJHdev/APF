...
<head>
	...
	$(document).ready(function() {
		// 서브메뉴바 로딩
		loadSearchSubBar('#search-subbar', getUrl('/usr/inform/search/listSearchMenu.do'));
	});
	</script>
...
<div class="wrap sub">
	...
	<div class="sub-banner <c:out value="${PAGEINFO.pageInfo.firstMenuId}"/>">
		<div class="row">
			...
			<div class="col-12 col-xl" id="appHeaderBox"></div>
			<div class="col-12 col-xl d-none d-xl-inline-flex">
				<img src="<c:url value="/images/menu/"/><c:out value="${PAGEINFO.pageInfo.firstMenuId}"/>.png" class="w-auto" alt="menuIcon">
			</div>
		</div>
	</div>

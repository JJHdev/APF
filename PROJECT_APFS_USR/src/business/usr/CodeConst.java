...
public class CodeConst {
    ...
    public static final String APRV_STTS_WAITING = "0";	// 승인대기
    public static final String APRV_STTS_APPROVE = "1";	// 승인
    public static final String APRV_STTS_REAPPLY = "8";	// 재신청
    public static final String APRV_STTS_REJECT  = "9";	// 반려
    ...
    public static final String TASK_SULD = "TS006"; // 경영체데이터업로드
    ...
    public static final String BIZMAIL_FUNDAPR = "BM01004"; // [사용자] 펀드지원하기 메일
	...
	// 지원신청 진행상태코드에 따른 단계번호 반화
	public static String getSprtStepNo(String sprtSeCd, String stepCd) {
		int no = 1;
		for (String code : SPRT_STEPS) {
			// 투자유치전지원인 경우 사업선택 SKIP
			if (SPRT_CHOOSE.equals(code) &&
				SPRT_APLY_SE_BEFORE.equals(sprtSeCd))
				continue;
				
			if (code.equals(stepCd))
    ...
    // 지원단계 목록
    public static final String[] SPRT_STEPS = new String[] {
		SPRT_AGREE  , // 약관동의
		SPRT_CHOOSE , // 지원사업선택
		SPRT_FORM   , // 신청서작성
		SPRT_FILE   , // 제출서류
    ...
    public static final String USE_STTS_UNUSED = "0";  // 미사용
    public static final String USE_STTS_USABLE = "1";  // 사용(승인)
    public static final String USE_STTS_REJECT = "9";  // 반려
    ...
    // 농금원 메일발송대상
    public static final String MNG_MAIL_SE	= "CT.MNGMAIL_SE";
}

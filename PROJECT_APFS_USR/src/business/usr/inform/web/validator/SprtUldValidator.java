...
/**
 * [검증클래스] - 운영관리-경영체 데이터 업로드 Server Side의 데이터 검증을 위한 Validator
 *
 * @class   : SprtUldValidator
 * @author  : LHB
 * @since   : 2023.07.13
 * @version : 1.0
 *
 ...
 */
@Service
public class SprtUldValidator implements Validator {
    ...
    public boolean supports(Class<?> type) {
        return SprtBizVO.class.isAssignableFrom(type);
    }

    @Override
    public void validate(Object o, Errors errors) {
    	
    	SprtBizVO data = (SprtBizVO) o;

...
public class CommConst {
    ...
    // 기업회원 - 농금원 사용자 ROLE
    public static final String USER_ROLE_MNG = "ROLE_USR_MNG";
    // 관리자 - 사용자시스템 시스템관리자 ROLE
    public static final String USER_ROLE_SYS = "ROLE_USR_SYS";

    // 관리자 - 관리자시스템 시스템관리자 ROLE
    public static final String ADMIN_ROLE_SYS = "ROLE_ADM_SYS";
    // 관리자 - 관리자시스템 운영관리자 ROLE
    public static final String ADMIN_ROLE_MNG = "ROLE_ADM_MNG";
    ...
    // 2023.09.19 LHB 로그인 구분 코드
    public static final String LGN_SE			= "CT.LGN_SE";
    // 일반 회원가입
    public static final String LGN_SE_NORMAL	= "P";
    // 네이버 회원가입
    public static final String LGN_SE_NAVER		= "N";
    // 카카오 회원가입
    public static final String LGN_SE_KAKAO		= "K";
    ...
    // 관리자 ROLE 배열
    public static final String[] ADMIN_ROLES = {ADMIN_ROLE_SYS, ADMIN_ROLE_MNG, USER_ROLE_SYS};
    // 업체회원 ROLE 배열
    // 2023.09.11 농금원사용자 추가
    public static final String[] BIZ_ROLES = {USER_ROLE_INV, USER_ROLE_ENT, USER_ROLE_RIS, USER_ROLE_MNG};
    // 투자자대상회원 ROLE 배열 (관리자/유관기관/투자자)
    // 2023.09.11 사용자시스템관리자 추가
    // 2023.09.11 농금원사용자 추가
    public static final String[] INVT_ROLES = {ADMIN_ROLE_SYS, ADMIN_ROLE_MNG, USER_ROLE_SYS, USER_ROLE_MNG, USER_ROLE_INV, USER_ROLE_RIS};
    // 지원서비스대상회원 ROLE 배열 (관리자/유관기관/경영체/사용자)
    public static final String[] SPRT_ROLES = {ADMIN_ROLE_SYS, ADMIN_ROLE_MNG, USER_ROLE_SYS, USER_ROLE_MNG, USER_ROLE_ENT, USER_ROLE_RIS};
    ...
    // 농금원관리자인지 확인하는 함수
    public static boolean isMngRole(String roleId) {
    	return USER_ROLE_MNG.equals(roleId);
    }
    // 일반회원인지 확인하는 함수
    ...
    // 지원서비스 사용자인지 확인하는 함수
    // 농금원관리자/유관기관/경영체인 경우
    public static boolean isSprtRole(String roleId) {
    	return Arrays.asList(SPRT_ROLES).contains(roleId);
    }
    // 투자자인지 확인하는 함수
    ...
    // 업체미승인 사용자의 저장 세션
    public static final String SESS_REJECT_USER = "SS_REJECT_USER";
